        ...
        exhaustMap((action: userActions.LoginUserSSA) => this.dataService.login(action.payload).pipe(
            map(
                (user: TokenizedUser) => {
                    ...
                    return of(new userActions.UpdateCurrentUserSOA(user), new DestroyBannerSOA(), new UpdateIsBusySOA(false));
                }),
            concatAll(),
            catchError((error) => {
                ...
                if (error instanceof DelayLoginError) {
                    ...
                    return of(new UpdateIsBusySOA(false), new DisplayBannerSOA({
                        predefined: '',
                        custom: {
                    ...
                    return of(new UpdateIsBusySOA(false), new DisplayBannerSOA({ predefined: 'loginFailure' }));
                }
