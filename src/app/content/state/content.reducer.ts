...
export const selectMasterDataState: MemoizedSelector<ContentSlice<ContentMainStates>, MasterDataState> = createSelector(
    selectContentMainStates,
    state => state.masterData
);

export const selectSupportContact: MemoizedSelector<ContentSlice<ContentMainStates>, string> = createSelector(
